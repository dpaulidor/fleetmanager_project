...
const initialVehicles = [
  ...
  },
  {
    ...
    disponibilite: "Non dispo",
    kilometrage: 67800,
    conducteur: "Lucie Bernard",
  },
  {
    id: 7,
    date: "25/02/26",
    action: "Dacia Sandero",
    etat: "Bon",
    disponibilite: "Disponible",
    kilometrage: 12500,
    conducteur: "—",
  ...
  },
  {
    id: 9,
    date: "05/03/26",
    action: "Mercedes Vito",
    etat: "Bon",
    disponibilite: "Non dispo",
    kilometrage: 75100,
    conducteur: "Nicolas Petit",
  },
  {
    id: 10,
    date: "10/03/26",
  ...
  },
  {
    ...
    disponibilite: "Non dispo",
    kilometrage: 52300,
    conducteur: "Emma Dubois",
  },
  {
    id: 12,
    date: "18/03/26",
    action: "Volkswagen Golf",
    etat: "Bon",
    disponibilite: "Non dispo",
    kilometrage: 19800,
    conducteur: "Thomas Moreau",
  },
  {
    id: 13,
    date: "22/03/26",
    ...
    disponibilite: "Non dispo",
    kilometrage: 8700,
    conducteur: "Alexandre Girard",
  },
  {
    id: 14,
    date: "28/03/26",
    action: "Tesla Model 3",
    etat: "Bon",
    disponibilite: "Non dispo",
    kilometrage: 12400,
    conducteur: "Julie Rousseau",
  },
  {
    id: 15,
    date: "30/03/26",
      ...
      <div className="dashboard-header">
        <div>
          ...
          <p className="greeting">
            Salut Mica {user ? user.name : "Utilisateur"} 👋
          </p>
        </div>
      ...
      <div className="charts-row">
        <div className="chart-card">
          ...
          <div className="max-badge">
            Jusqu'à {maxRevenue.toLocaleString()} G
          </div>
        ...
        <div className="chart-card">
          ...
          <div className="pie-legend">
            <div className="legend-item">
              <span className="color-dot green"></span> Bon état:{" "}
              {vehicles.filter((v) => v.etat === "Bon").length}
            </div>
            <div className="legend-item">
              <span className="color-dot red"></span> Panne:{" "}
              {vehicles.filter((v) => v.etat === "En panne").length}
            </div>
            <div className="legend-item">
              <span className="color-dot orange"></span> Entretien:{" "}
              {vehicles.filter((v) => v.etat === "Entretien").length}
            </div>
          </div>
          <div className="simple-pie">
            <div
              className="pie-segment green"
              style={{
                width: `${(vehicles.filter((v) => v.etat === "Bon").length / vehicles.length) * 100}%`,
              }}
            ></div>
            <div
              className="pie-segment red"
              style={{
                width: `${(vehicles.filter((v) => v.etat === "En panne").length / vehicles.length) * 100}%`,
              }}
            ></div>
            <div
              className="pie-segment orange"
              style={{
                width: `${(vehicles.filter((v) => v.etat === "Entretien").length / vehicles.length) * 100}%`,
              }}
            ></div>
          </div>
        </div>
        <div className="chart-card">
          ...
          <div className="pie-legend">
            <div className="legend-item">
              <span className="color-dot blue"></span> Disponible:{" "}
              {vehicles.filter((v) => v.disponibilite === "Disponible").length}
            </div>
            <div className="legend-item">
              <span className="color-dot gray"></span> Non dispo:{" "}
              {vehicles.filter((v) => v.disponibilite === "Non dispo").length}
            </div>
          </div>
          <div className="simple-pie">
            <div
              className="pie-segment blue"
              style={{
                width: `${(vehicles.filter((v) => v.disponibilite === "Disponible").length / vehicles.length) * 100}%`,
              }}
            ></div>
            <div
              className="pie-segment gray"
              style={{
                width: `${(vehicles.filter((v) => v.disponibilite === "Non dispo").length / vehicles.length) * 100}%`,
              }}
            ></div>
          </div>
        </div>
      ...
      <div className="control-bar">
        <div className="search-filter">
          ...
          >
            ...
            <option value="En panne">Panne</option>
      ...
      <div className="table-card">
        <div className="table-wrapper">
            ...
            <tbody>
              {filteredVehicles.map((vehicle) => (
                <tr key={vehicle.id}>
                  ...
                  <td>
                    <select
                      className={`status-select ${vehicle.etat === "Bon" ? "status-good" : vehicle.etat === "En panne" ? "status-bad" : "status-warning"}`}
                      value={vehicle.etat}
                      onChange={(e) =>
                        updateVehicleStatus(vehicle.id, "etat", e.target.value)
                      }
                    >
                      <option>Bon</option>
                  ...
                  <td>
                    <select
                      className={`dispo-select ${vehicle.disponibilite === "Disponible" ? "dispo-yes" : "dispo-no"}`}
                      value={vehicle.disponibilite}
                      onChange={(e) =>
                        updateVehicleStatus(
                          vehicle.id,
                          "disponibilite",
          ...
          {filteredVehicles.length === 0 && (
            <div className="empty-table">Aucun véhicule trouvé</div>
          )}
        </div>
      </div>
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) =>
                  setNewVehicle({ ...newVehicle, action: e.target.value })
                }
            ...
            <div className="form-row">
              <div className="form-group">
                <label>État</label>
                <select
                  value={newVehicle.etat}
                  onChange={(e) =>
                    setNewVehicle({ ...newVehicle, etat: e.target.value })
                  }
                >
                  <option>Bon</option>
                  <option>En panne</option>
              ...
              <div className="form-group">
                ...
                <select
                  value={newVehicle.disponibilite}
                  onChange={(e) =>
                    setNewVehicle({
                      ...newVehicle,
            ...
            <div className="form-row">
              ...
              <div className="form-group">
                ...
                <input
                  type="text"
                  value={newVehicle.conducteur}
                  onChange={(e) =>
                    setNewVehicle({ ...newVehicle, conducteur: e.target.value })
                  }
                  placeholder="Nom"
                />
              </div>
            ...
            <div className="modal-actions">
              ...
              <button className="submit-btn" onClick={handleSaveVehicle}>
